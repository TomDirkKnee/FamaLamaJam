...
- Current baseline commit before the next direct UI iteration: `85ef11e`
...
| `UI-003` | done | Refresh local strip layout immediately after add or remove so channels do not disappear until another resize | `85ef11e` | pending | `git revert <final-commit>` |

## Next ID

- Next feature entry: `UI-004`
